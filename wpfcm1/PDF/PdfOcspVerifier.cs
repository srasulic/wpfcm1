 ...
 * Srdjan 14/01/2019
 * 
 * BUGFIX - provera opozvanosti sertifikata kojim je potpisan OCSP je radjena 
 * na datum validacije. Promenjeno da se vrši na datum potpisivanja.
 * 
 * */
...
{
    public class PdfOcspVerifier : RootStoreVerifier
    {
        /** The Logger instance */
        private static ILogger LOGGER = LoggerFactory.GetLogger(typeof(PdfOcspVerifier));
	     ...
	     */
        public PdfOcspVerifier(CertificateVerifier verifier, List<BasicOcspResp> ocsps) : base(verifier)
        {
            this.ocsps = ocsps;
        }
