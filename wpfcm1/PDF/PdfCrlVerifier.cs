...
{
    public class PdfCrlVerifier : RootStoreVerifier
    {
        /** The Logger instance */
        private static ILogger LOGGER = LoggerFactory.GetLogger(typeof(PdfCrlVerifier));
	     ...
	     */
        public PdfCrlVerifier(CertificateVerifier verifier, List<X509Crl> crls) : base(verifier)
        {
            this.crls = crls;
        }
