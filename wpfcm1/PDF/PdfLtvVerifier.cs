...
{
    public class PdfLtvVerifier : RootStoreVerifier
    {
        /** The Logger instance */
        private static ILogger LOGGER = LoggerFactory.GetLogger(typeof(PdfLtvVerifier));
	     ...
	     */
        public PdfLtvVerifier(PdfReader reader) : base(null)
        {
            this.reader = reader;
        ...
        override public List<VerificationOK> Verify(X509Certificate signCert, X509Certificate issuerCert, DateTime sigDate)
        {
            ...
            PdfCrlVerifier crlVerifier = new PdfCrlVerifier(rootStoreVerifier, GetCRLsFromDSS());
